...
class VadereParser:
    ...
    def _get_model(self):
        ...
        if self.scenario_parser.get("scenario").get("attributesPsychology").get("usePsychologyLayer"):
            psychology_model.perception_model = self.scenario_parser.get("scenario").get("attributesPsychology").get("psychologyLayer").get("perception")
            psychology_model.cognition_model = self.scenario_parser.get("scenario").get("attributesPsychology").get("psychologyLayer").get("cognition")
    ...
    def parse_trajectories(self, archive, logger):
        ...
        self.results.m_create(ScenarioProperties)
    ...
    def parse(self, filepath, archive, logger):
        ...
        # read results from raw files and derive results
