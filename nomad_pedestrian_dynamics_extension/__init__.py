...
vadere_parser_entry_point = EntryPoint(
    ...
    python_package='nomad_pedestrian_dynamics_extension.vadere',
    mainfile_name_re=r'^\s*#\s*postvis.traj',
    parser_class_name='nomad_pedestrian_dynamics_extension.vadere.VadereParser',
    code_name='Vadere',
    ...
    metadata={
        ...
        'parserDirName': 'dependencies/parsers/nomad_pedestrian_dynamics_extension/nomad_pedestrian_dynamics_extension/vadere',
        'parserGitUrl': '',
        'parserSpecific': '',
        'status': '',
        'tableOfFiles': '',
